...
class Simulation(object):
    ...
    def _compile_tpr(self, step_name: str,
        ...
        if hasattr(gromacs.tools, 'Grompp'):
            grompp_cls = gromacs.tools.Grompp
        elif hasattr(gromacs.tools, 'Grompp_mpi'):
            grompp_cls = gromacs.tools.Grompp_mpi
        else:
    ...
    def _run_mdrun(self, step_name: str, tpr: GenPath = None
        ...
        if hasattr(gromacs.tools, 'Mdrun'):
            mdrun_cls = gromacs.tools.Mdrun
        elif hasattr(gromacs.tools, 'Mdrun_mpi'):
            mdrun_cls = gromacs.tools.Mdrun_mpi
        else:
